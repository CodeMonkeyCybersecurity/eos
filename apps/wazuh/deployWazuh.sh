...
echo "================================"
read -p "Press enter to change the exposed port to 8011, to make it compatible with a Eos/Hecate setup"
...
generate_hash
read -p "Enter the generated hash value " WZ_ADMIN_BCRYPT
