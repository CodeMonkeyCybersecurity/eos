...
var restoreCmd = &cobra.Command{
	...
	Long: `Restore files from a restic snapshot.
...
func restoreSnapshot(rc *eos_io.RuntimeContext, cmd *cobra.Command, args []string) error {
