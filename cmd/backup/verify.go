...
var verifyRepoCmd = &cobra.Command{
	...
	RunE:  eos.Wrap(verifyRepository),
}
...
func verifyRepository(rc *eos_io.RuntimeContext, cmd *cobra.Command, args []string) error {
...
func verifySnapshot(rc *eos_io.RuntimeContext, cmd *cobra.Command, args []string) error {
	logger := otelzap.Ctx(rc.Ctx)
