...
// NOTE: saveDebugOutput was removed. Use pkg/debug/capture.go infrastructure instead.
// See CLAUDE.md section "Automatic Debug Output Capture" for migration instructions.
