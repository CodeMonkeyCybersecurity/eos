  ...
  eos read wazuh agents --limit 25 --refresh 3`,
	RunE: eos.Wrap(func(rc *eos_io.RuntimeContext, cmd *cobra.Command, args []string) error {
		...
		logger.Info(" Starting agents watch",
			zap.Int("limit", wazuhAgentsLimit),
			zap.Int("refresh_seconds", wazuhAgentsRefresh))

		// Get database DSN
		if wazuhAgentsDsn == "" {
			wazuhAgentsDsn = os.Getenv("AGENTS_PG_DSN")
			if wazuhAgentsDsn == "" {
		...
		// Connect to database
		db, err := sql.Open("postgres", wazuhAgentsDsn)
		if err != nil {
		...
		// Start watching
		return watchAgents(rc.Ctx, logger, db, wazuhAgentsLimit, wazuhAgentsRefresh)
	}),
}
...
// TODO: Move to pkg/wazuh/monitoring or pkg/wazuh/agents
...
// TODO: Move to pkg/wazuh/display or pkg/wazuh/output
...
// TODO: Move to pkg/wazuh/display or pkg/shared/terminal
...
// TODO: Move to pkg/wazuh/agents or pkg/wazuh/stats
