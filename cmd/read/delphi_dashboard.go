...
// delphiDashboardCmd launches the interactive Delphi pipeline dashboard
var delphiDashboardCmd = &cobra.Command{
...
Examples:
  eos read delphi dashboard                    # Launch with overview (default)
  eos read delphi dashboard services          # Launch directly to services module
  eos read delphi dashboard pipeline          # Launch directly to pipeline module
