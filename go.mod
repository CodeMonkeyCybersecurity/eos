...
// TEMPORARILY REMOVED: tailscale.com (incompatible with Go 1.24)
...
// Temporary: Force older versions for Go 1.24 compatibility
// Will be removed when upgrading back to Go 1.25+
