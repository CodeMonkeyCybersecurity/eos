...
# Global configuration
{
	...
	#           1. Inside container (localhost)
	#           2. Host machine (via bridge IP)
	#           3. Other containers on same bridge network
	...
	# VENDOR: Caddy docs recommend 0.0.0.0 for containerized deployments
	admin 0.0.0.0:2019
