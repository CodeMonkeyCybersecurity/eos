...
func GetDefaultNetwork() string {
	// TODO: Could detect if we're using libvirt and check available networks
	return "default"
}

// GetDefaultStoragePool returns the default storage pool name
func GetDefaultStoragePool() string {
	// TODO: Could detect available storage pools
	return "default"
}
...
func CheckSystemResources(config *SecureVMConfig) error {
	...
	// TODO: Could also check actual available system resources using runtime.NumCPU(), etc.
