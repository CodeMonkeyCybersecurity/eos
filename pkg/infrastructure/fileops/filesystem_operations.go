...
// FileSystemOperations implements fileops.FileOperations using the OS filesystem
type FileSystemOperations struct {
	logger *zap.Logger
}

// NewFileSystemOperations creates a new filesystem operations implementation
func NewFileSystemOperations(logger *zap.Logger) fileops.FileOperations {
	return &FileSystemOperations{
		logger: logger.Named("fileops.filesystem"),
	}
}
