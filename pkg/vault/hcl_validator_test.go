...
// stringContains is a helper function for testing
// Prefixed with underscore to indicate it's intentionally unused (reserved for future tests)
//
//nolint:unused
func _stringContains(s, substr string) bool {
