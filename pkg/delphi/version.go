// pkg/delphi/version.go
//
// Delphi Version Management System
//
// This package provides centralized Delphi/Wazuh version management that solves the manual
...
//
// Quick Start:
//   latest, err := GetLatestDelphiVersion(rc)
//   if err != nil {
...
// DefaultDelphiVersion is the fallback version when API is unavailable
const DefaultDelphiVersion = "4.13.0"

// VersionManager handles Delphi version management.
//
// The VersionManager provides the core functionality for fetching, caching, and comparing
// Delphi/Wazuh versions. It uses the GitHub API to get release information and implements
// intelligent caching to avoid rate limits.
//
// Architecture:
// - Fetches from GitHub API: https://api.github.com/repos/wazuh/wazuh/releases
// - Caches results locally in ~/.eos/cache/delphi-versions/
