// pkg/delphi/version_config.go
//
// Delphi Version Configuration Management
//
// This file provides version configuration management for Delphi deployments.
// Since Delphi is your own implementation of Wazuh, this handles version
...
// VersionConfig represents Delphi version configuration
...
// ConfigManager handles Delphi version configuration
...
func NewConfigManager() *ConfigManager {
	configPath := xdg.XDGConfigPath(shared.EosID, "delphi-version.json")
...
func (cm *ConfigManager) LoadConfig(rc *eos_io.RuntimeContext) (*VersionConfig, error) {
	...
	logger.Info("Loaded Delphi version configuration", 
...
func (cm *ConfigManager) SaveConfig(rc *eos_io.RuntimeContext, config *VersionConfig) error {
	...
	logger.Info("Saved Delphi version configuration", zap.String("path", cm.configPath))
	return nil
}
...
func DefaultVersionConfig() *VersionConfig {
	return &VersionConfig{
		CurrentVersion:     DefaultDelphiVersion,
