...
// RunCleanup removes Delphi Docker deployment
// Migrated from cmd/create/delphi.go runCleanup
func RunCleanup(rc *eos_io.RuntimeContext, removeData, force bool) error {
	...
	if !force {
		logger.Info("terminal prompt: Are you sure you want to remove the Delphi deployment? (yes/no)")
