...
// ListDeployments returns all Helen deployments across namespaces
...
// CreateBackup creates a backup of Helen data
func (m *Manager) CreateBackup(ctx context.Context, backupPath string) error {
	// For Helen (static website), we backup the public HTML files
	return fmt.Errorf("backup functionality will be implemented to backup HTML files")
}

// RestoreBackup restores Helen data from a backup
func (m *Manager) RestoreBackup(ctx context.Context, backupPath string) error {
	// For Helen, this would restore HTML files
	return fmt.Errorf("restore functionality will be implemented to restore HTML files")
}
...
// checkWebsiteHealth performs a basic HTTP check on the deployed website
func (m *Manager) checkWebsiteHealth(ctx context.Context) bool {
	// This would typically use HTTP client to check if the website is responding
