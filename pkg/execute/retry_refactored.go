// pkg/execute/retry_refactored.go
...
// TODO: This is a refactored version of retry.go following Eos standards:
...
// RetryCommandRefactored retries execution with structured logging and proper error handling
func RetryCommandRefactored(rc *eos_io.RuntimeContext, maxAttempts int, delay time.Duration, name string, args ...string) error {
