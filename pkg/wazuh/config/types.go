...
// WazuhAPIConfig represents Wazuh API configuration
...
// WazuhConfig represents the complete Wazuh pipeline configuration
type WazuhConfig struct {
	...
	WazuhAPI             WazuhAPIConfig             `json:"wazuh" mapstructure:"wazuh"`
...
// DefaultWazuhConfig returns a configuration with sensible defaults
func DefaultWazuhConfig() *WazuhConfig {
	return &WazuhConfig{
		...
		FilePaths: FilePathsConfig{
			...
			EmailTemplatePath: "/opt/stackstorm/packs/wazuh/email.html",
		},
		NotificationChannels: NotificationChannelsConfig{
			Channels: map[string]string{
				"new_alert":        "wazuh-listener → wazuh-agent-enricher",
				"agent_enriched":   "wazuh-agent-enricher → llm-worker",
