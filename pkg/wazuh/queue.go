// pkg/wazuh/queue.go - Redis Streams implementation for Wazuh pipeline
package wazuh
...
// StreamMessage represents a message in the Wazuh pipeline
...
// StreamHandler manages Redis streams for the Wazuh pipeline
...
func NewStreamHandler(redisURL, consumerGroup string, logger *zap.Logger) (*StreamHandler, error) {
	...
	streams := map[string]string{
		"new_alert":        "wazuh:alerts:new",
		"agent_enriched":   "wazuh:alerts:enriched",
		"new_response":     "wazuh:alerts:analyzed",
		"alert_structured": "wazuh:alerts:structured",
		"alert_formatted":  "wazuh:alerts:formatted",
	}
