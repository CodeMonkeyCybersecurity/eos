...
// Migrated from cmd/create/wazuh.go runCredentialsChange
...
// Migrated from cmd/create/wazuh.go updateAdminPassword
...
// Migrated from cmd/create/wazuh.go updateKibanaPassword
...
// Migrated from cmd/create/wazuh.go updateAPIPassword
...
// Migrated from cmd/create/wazuh.go updateComposeFile
...
// Migrated from cmd/create/wazuh.go updateInternalUsers
...
// Migrated from cmd/create/wazuh.go updateWazuhYML
...
// Migrated from cmd/create/wazuh.go replaceInFile
...
// Migrated from cmd/create/wazuh.go generatePasswordHash
