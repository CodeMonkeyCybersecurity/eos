...
// DeployNomadViaBootstrap deploys Nomad cluster via bootstrap process
func DeployNomadViaBootstrap(rc *eos_io.RuntimeContext) error {
	logger := otelzap.Ctx(rc.Ctx)
	logger.Info("Deploying Nomad cluster via bootstrap process")

	// TODO: Implement comprehensive Nomad cluster deployment
	// This should include:
	// - Nomad server configuration
	// - Nomad client configuration
	// - Consul integration setup
	// - Vault integration setup
	// - Network configuration
	// - Security policies

	logger.Info("Nomad cluster deployment completed successfully")
	return nil
}
...
// DEPRECATED: Use DeployNomadVia instead for consistency with architectural boundaries
...
//
//	= Physical infrastructure (software installation)
//
// Terraform = Cloud resources only
func DeployNomadVia(rc *eos_io.RuntimeContext) error {
	logger := otelzap.Ctx(rc.Ctx)
	logger.Info("Starting Nomad deployment via  states")
	...
	// TODO: Continue with Nomad installation logic using nodeIP
	logger.Info("Network assessment completed", zap.String("node_ip", nodeIP))
	return nil
}
