...
// Docker Compose Management Types
...
// ComposeManagementConfig contains configuration for container management operations
type ComposeManagementConfig struct {
...
// DefaultComposeManagementConfig returns a configuration with sensible defaults
func DefaultComposeManagementConfig() *ComposeManagementConfig {
	return &ComposeManagementConfig{
